...
public class Inventory : MonoBehaviour
{
    ...
    public void TambahItemHasilPanen(Sprite hasilPanen)
    {
        RefreshData();
        ...
        for (int i = 0; i < dtg.barang.Count; i++)
        {
            ...
            if (dtg.barang[i].gambar != null && dtg.barang[i].gambar.name == hasilPanen.name)
            {
        ...
        {
            dtg.barang[emptySlot].gambar = hasilPanen;
            dtg.barang[emptySlot].nama = hasilPanen.name;
